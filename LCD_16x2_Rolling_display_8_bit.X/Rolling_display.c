/*
 * Interfacing 16x2 LCD with PIC18F4550 to display rolling character
 * Author : Ali
 */
...
{       
    ...
    LCD_String_xy(1,0,"ENSA AGADIR");      /*Display string at location(row,location).This function passes string to display*/    
    while(1)
    {
        for(i=0;i<shift;i++)
        {    
